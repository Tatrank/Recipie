  ...
  return (
    <AnimatePresence key={data.id}>
      <motion.div
        ...
        className="md:w-[400px] md:scale-100 scale-50 w-[375px] rounded-3xl  h-[600px] border-4 border-secondary-dark overflow-hidden"
      >
        <div
          style={{
        ...
        >
          {!showData ? (
            <motion.div className="flex p-4 flex-col items-center justify-between h-full w-full bg-primary-dark  backdrop-filter backdrop-blur-sm bg-opacity-50">
              <div className="w-full h-20 p-2 text-4xl">
                {data.likes.length}
              </div>
